<?php /* Smarty version Smarty-3.1.8, created on 2015-04-21 19:10:25
         compiled from "/home/cwr-user/cwrdiversity.org/CWR-DistributionMap/templates/distribution-map.tpl" */ ?>
<?php /*%%SmartyHeaderCode:157219328355196af15e8538-03638953%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd6e5ea29e8e29087e8fcc4cc51eee0a54f93888' => 
    array (
      0 => '/home/cwr-user/cwrdiversity.org/CWR-DistributionMap/templates/distribution-map.tpl',
      1 => 1429643071,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '157219328355196af15e8538-03638953',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_55196af17a5677_65517145',
  'variables' => 
  array (
    'taxonomyList' => 0,
    'taxonItem' => 0,
...
<?php if ($_valid && !is_callable('content_55196af17a5677_65517145')) {function content_55196af17a5677_65517145($_smarty_tpl) {?><!-- Header Title -->
<html>
    <header>        
	<script type="text/javascript">
            document.title =  "CWR Distribution Map" ;
            var taxonomy = [
            <?php  $_smarty_tpl->tpl_vars['taxonItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['taxonItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['taxonomyList']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['taxonItem']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['taxonItem']->iteration=0;
foreach ($_from as $_smarty_tpl->tpl_vars['taxonItem']->key => $_smarty_tpl->tpl_vars['taxonItem']->value){
$_smarty_tpl->tpl_vars['taxonItem']->_loop = true;
 $_smarty_tpl->tpl_vars['taxonItem']->iteration++;
 $_smarty_tpl->tpl_vars['taxonItem']->last = $_smarty_tpl->tpl_vars['taxonItem']->iteration === $_smarty_tpl->tpl_vars['taxonItem']->total;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['taxonloop']['last'] = $_smarty_tpl->tpl_vars['taxonItem']->last;
?>
                <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['taxonloop']['last']){?>
                    "<?php echo $_smarty_tpl->tpl_vars['taxonItem']->value->getTaxonomy();?>
",
                <?php }else{ ?>
                    "<?php echo $_smarty_tpl->tpl_vars['taxonItem']->value->getTaxonomy();?>
"
            ...
            var cropcodes = [
            <?php  $_smarty_tpl->tpl_vars['taxonItem'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['taxonItem']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['cropcodeList']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['taxonItem']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['taxonItem']->iteration=0;
foreach ($_from as $_smarty_tpl->tpl_vars['taxonItem']->key => $_smarty_tpl->tpl_vars['taxonItem']->value){
$_smarty_tpl->tpl_vars['taxonItem']->_loop = true;
...
?>
                <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['taxonloop']['last']){?>
                    "<?php echo $_smarty_tpl->tpl_vars['taxonItem']->value->getCropCode();?>
",
                <?php }else{ ?>
                    "<?php echo $_smarty_tpl->tpl_vars['taxonItem']->value->getCropCode();?>
"
...
/map.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo @SMARTY_CSS_URI;?>
/reveal.css" />
        <link rel="shortcut icon" href="<?php echo @SMARTY_IMG_URI;?>
/logo-favicon.ico">
...
/check.png"/>
        ...
        <div id="zoomControl">
            <img id="control-plus" src="<?php echo @SMARTY_IMG_URI;?>
/plus.png"/><br>
            <img id="control-minus" src="<?php echo @SMARTY_IMG_URI;?>
/minus.png"/>
        </div
        <!-- Control del tipo de mapa -->
        <div id="main_page_buttons">
            <div id="roadmap" title="Map"><img src="<?php echo @SMARTY_IMG_URI;?>
/map_ico_T_B3.png"/></div>
            <div id="terrain" title="Terrain"><img src="<?php echo @SMARTY_IMG_URI;?>
/terrain_ico_T_B2.png"/></div>
            <div id="satellite" title="Satellite"><img src="<?php echo @SMARTY_IMG_URI;?>
/satellite_ico_T_B2.png"/></div>
        </div> 
        ...
        <div id="escalaColores">
            <!--<img id="control-plus" src="<?php echo @SMARTY_IMG_URI;?>
/sp-rich_rclassscaleTestImage.png"/>-->
        </div>
