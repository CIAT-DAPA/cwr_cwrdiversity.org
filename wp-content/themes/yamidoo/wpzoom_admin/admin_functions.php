...
$themename = "Yamidoo Magazine";
$shortname =  "wpzoom";

$options = array (

array(    "name" => "Yamidoo Magazine Settings",
        "type" => "title"),
...
array(    "name" => "Do you want to use AutoEmbed?",
        "desc" => "<a href='http://autoembed.com/'>AutoEmbed</a> is a built-in utility, which allows you to embed automatically videos in the slider or posts simply specifyin the URL of a video, instead of Embed Code.",
        "id" => $shortname."_autoembed",
        "options" => array('No','Yes'),
        "std" => "No",
        "type" => "select"),
...
array(    "name" => "Show Post Thumbnail in Sidebar?",
         "id" => $shortname."_sidebar_thumb_show",
        "options" => array('Yes','No'),
        "std" => "Yes",
        "type" => "select"),
...
array(    "name" => "<img align='left' style='padding:0px 3px 0 0;' src='$homepath/images/twitter.png' />Show Twitter icon in Main Menu?",
        "desc" => "",
...
<div id="zoomWrap">
  <div id="zoomHead">
	...
	<div id="zoomInfo"><ul><li class="server <?php if(version_compare(phpversion(), '5.2.0', '>')){ ?>activeyes<?php } else { ?>activeno<?php } ?>"><abbr title="PHP 5.2 or above is required">PHP Version: <?php echo phpversion(); ?></abbr></li><li class="documentation"><a href="http://www.wpzoom.com/documentation/yamidoo-magazine/">Documentation</a></li><li class="support"><a href="http://www.wpzoom.com/forum" target="_blank">Support Forum</a></li></ul></div>
  </div>
