...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            ...
            <div class="post" id="post-<?php the_ID(); ?>">
                ...
                <small><?php the_category(', ') ?> &mdash; on  <?php the_time("$dateformat $timeformat"); ?>   <?php edit_post_link(__('Edit', 'wpzoom'), ' | ', ''); ?></small><br />
        ...
        <?php if ($wpzoom_singlepost_share == 'Show') { ?>
                    <div id="socialicons">
                        ...
                        <ul>
                            ...
                            <li><?php if (strlen($wpzoom_misc_feedburner) > 1) {
                echo"<a href=\"$wpzoom_misc_feedburner\">";
            } else { ?><a href="<?php bloginfo('rss2_url'); ?>"> <?php } ?><img src="<?php bloginfo('template_directory'); ?>/images/feed.png" alt="Subscribe by RSS" /><?php _e('RSS Feed', 'wpzoom'); ?></a></li>
