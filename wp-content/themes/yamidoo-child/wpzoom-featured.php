 	...
 	<div>
		...
		<?php if (strlen($videocode) > 1 && $wpzoom_autoembed == "Yes") {
 		...
 		<?php unset($img); 
			...
			<img src="<?php bloginfo('template_directory'); ?>/scripts/timthumb.php?src=<?php echo $img ?>&amp;w=480&amp;h=280&amp;zc=1" alt="<?php the_title(); ?>" /><?php } else { echo"<img src=\""; bloginfo('template_directory'); echo"/images/blank.jpg\" />"; } 
