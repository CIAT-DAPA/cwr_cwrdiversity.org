			...
			if (!$javascript) {
						...
						if ($photos)
						{
							...
							foreach($photos["items"] as $key => $value)
							{
								...
								$thickbox_attrib = ($thickbox) ? "class=\"thickbox\" rel=\"flickr-gallery\" title=\"$photo_title:   $photo_description </a> &raquo;\"" : "";
								$href = ($thickbox) ? $photo_medium_url : $photo_link;
								
								$photo_title = ($show_titles) ? "<div class=\"qflickr-title\">$photo_title</div>" : "";
								$out .= $before_item . "<a $thickbox_attrib $target href=\"$href\"><img vspace=\"2\" hspace=\"5\" class=\"flickr_photo\" alt=\"$photo_title\" title=\"$photo_title\" src=\"$photo_url\" /></a>$photo_title" .  $after_item;
							}
							if($randomTagText != "") { 
				...
				$out .= "<br><a href='http://www.flickr.com/photos/cropwildrelatives/' target='_BLANK'>Go to CWR Flickr</a>";
			?>
